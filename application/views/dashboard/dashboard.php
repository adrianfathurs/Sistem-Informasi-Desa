<div class="container">
  ...
  <div class="wrap">
    ...
    <div class="card-body">
      <h4 class="card-title" style="text-align:center"><b>Sistem Informasi Pengelolaan Keuangan Pembangunan Desa Kedung Pomahan Wetan</b></h4>
      <hr>
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
              <a href="<?php echo base_url("Parameter")?>" class="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        </div>
